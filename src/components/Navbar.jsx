    ...
    <nav className='bg-base-200 border-b border-base-300 sticky top-0 z-30 h-16 flex items-center'>
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='flex items-center justify-end w-full'>
          <Link to="/sterl-portfolio/" className='flex items-center gap-2.5'>
          ...
          <div className='hidden md:flex items-center gap-3 sm:gap-4 ml-auto space-x-8'>
            <Link to={"/sterl-portfolio/about"}>
              <span className='text-xl font-mono text-white'>
                About
              </span>
            </Link>

            <Link to={"/sterl-portfolio/projects"}>
              <span className='text-xl font-mono text-white'>
                Projects
              </span>
            </Link>

            <Link to={"/sterl-portfolio/contacts"}>
              <span className='text-xl font-mono text-white'>
                Contacts
              </span>
            </Link>
